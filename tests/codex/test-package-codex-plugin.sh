...
assert_contains "$archive_paths" "skills/codegraph-usage/SKILL.md" "archive includes the CodeGraph skill"
assert_contains "$archive_paths" "skills/codegraph-usage/agents/openai.yaml" "archive includes CodeGraph OpenAI metadata"
